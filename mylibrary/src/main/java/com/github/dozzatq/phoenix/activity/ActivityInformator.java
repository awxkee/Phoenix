...
class ActivityInformator implements Runnable {
    private ActivityConnector activitySupportConnector;
    private int activityState;
    private ActivitySupplier activitySupplier;
    private String key;

    ActivityInformator(ActivityConnector activitySupportConnector, int activityState, ActivitySupplier activitySupplier, String key) {
